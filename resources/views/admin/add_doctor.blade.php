            ...
            <div class="container" align="center" style="padding-top:100px;">
                ...
                <form action="{{ url('upload_doctor') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div style="padding: 15px;">
                        ...
                        <input type="text" style="color: black;" name="name" id="name" placeholder="Write the name" required="">
                    </div>

                    <div style=" padding: 15px;">
                        <label for="number">Phone Number:</label>
                        <input type="number" style="color: black;" name="number" id="number" placeholder="Write the number" required="">
                    </div>
                    ...
                    <div style="padding: 15px;">
                        ...
                        <input type="number" style="color: black;" name="room" id="room" placeholder="Write the room number" required="">
                    </div>
