...
<body>
    ...
    <div align="center" style="padding: 70px;">
        <table>
            ...
            <tr style="background-color:cadetblue;" align=" center">
                ...
                <td>
                    <a class="bt btn-danger" onclick="return confirm('Are you sure want to delete this appointment')" href=" {{url('cancel_appoint',$appoints->id)}}">Cancel</a>
                </td>
